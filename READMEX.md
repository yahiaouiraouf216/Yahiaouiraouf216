<h1 align="center">Hi 👋, I'm Abderaouf Yahiaoui</h1>
<h3 align="center">DevOps & Cloud Engineer | AWS Certified Solutions Architect Associate (SAA-C03)</h3>

<p align="center">
I'm a Cloud & DevOps enthusiast based in Montréal, Canada 🇨🇦, transitioning into Cloud Engineering and DevOps after a long career in production/technical operations. My focus: AWS, Infrastructure as Code, Automation, Containers, and CI/CD.
</p>

- 🌍 Based in Montréal, Canada
- 🖥️ Portfolio: [github.com/yahiaouiraouf216](https://github.com/yahiaouiraouf216)
- ✉️ Contact: [yahiaouiraouf216@gmail.com](mailto:yahiaouiraouf216@gmail.com)
- 🔗 [LinkedIn](https://www.linkedin.com/in/yahiaouiraouf)
- 🚀 Currently building **[ResilienceOps](https://github.com/yahiaouiraouf216/Resilienceops)** — a Chaos Engineering & Self-Healing Infrastructure platform (FastAPI, PostgreSQL, Prometheus, Docker, Kubernetes/AWS EKS)
- 📚 Currently learning: Kubernetes (INFO94 certification, Oct–Nov 2026), Ansible, Grafana, Prometheus, Python
...
AWS: EC2 • S3 • IAM • VPC • Route53 • CloudWatch • RDS • ALB • Auto Scaling • Lambda
...
**🚀 [ResilienceOps](https://github.com/yahiaouiraouf216/Resilienceops)**
Chaos Engineering & Self-Healing Infrastructure platform — dashboard for incident tickets, simulated chaos experiments, automated remediations, and Prometheus metrics (MTTR, availability).
`FastAPI` `PostgreSQL` `Prometheus` `Docker` `Kubernetes` `AWS EKS`

**🚀 [Northstar](https://github.com/yahiaouiraouf216)**
End-to-end DevOps pipeline: code → GitHub Actions (test, security scan, build) → Docker Hub → Terraform → AWS EC2, deploying a containerized Flask app.
`AWS` `Terraform` `Docker` `GitHub Actions` `Flask`

**🎫 [OpsDesk](https://github.com/yahiaouiraouf216)**
IT ticket management platform, built as the application base for a full DevOps pipeline (Docker, CI/CD, Terraform, AWS) added on top.
`Flask` `PostgreSQL` `Docker` `REST API` `pytest`

**🏗️ [terraform-aws-portfolio](https://github.com/yahiaouiraouf216/terraform-aws-portfolio)**
Terraform-based AWS infrastructure portfolio project for hands-on IaC practice.
`Terraform` `AWS`
...
<p align="left">
<a href="https://www.linkedin.com/in/yahiaouiraouf" target="_blank" rel="noreferrer">
